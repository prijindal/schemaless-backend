...
import { initializeUser, isInitialized, loginUser } from "../utils/api";
...
export const action: ActionFunction = async ({
  ...
  const initializeResponse = await initializeUser(username?.slice() as string, password?.slice() as string);
